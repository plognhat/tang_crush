const CONFIG = {
    ...
    btnIntro: 'jz',
    title: 'Cậu ju tớ phải hok 😙',
    desc: 'Cậu không trả lời hoặc thoát ra, tức là cậu ju đó nha :>',
    btnYes: ' ju :33',
    btnNo: 'hok ju pp:))',
    question: 'Nói cho tới lý do vì sao cậu ju  đi <3',
    btnReply: 'Gửi cho Nhật',
    reply: 'Tại vì tôi thích :(',
    mess: 'Tớ biết mà hihi 🥰 ',
    messDesc: 'còn giờ thì chờ gì nữa mà không inbox nói cho tớ là cậu ju toii đi nào.',
    btnAccept: 'oke nha ',
    messLink: 'https://www.facebook.com/phlognhat.uwu/', //link fb
